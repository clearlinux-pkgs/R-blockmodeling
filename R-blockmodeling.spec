...
Source0  : https://cran.r-project.org/src/contrib/blockmodeling_1.1.5.tar.gz
...
pushd ..
cp -a blockmodeling buildavx2
popd
pushd ..
cp -a blockmodeling buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1737135758
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/blockmodeling/libs/blockmodeling.so
/V4/usr/lib64/R/library/blockmodeling/libs/blockmodeling.so
